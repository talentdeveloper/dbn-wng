...
public class Tester {
    ...
    public Tester(String secretPhrase) {
        ...
        if (account != null) {
            this.initialBalance = account.getBalanceDQT();
            this.initialUnconfirmedBalance = account.getUnconfirmedBalanceDQT();
            this.initialEffectiveBalance = account.getEffectiveBalanceDBN();
    ...
    public long getBalanceDiff() {
        return Account.getAccount(id).getBalanceDQT() - initialBalance;
    }

    public long getUnconfirmedBalanceDiff() {
        return Account.getAccount(id).getUnconfirmedBalanceDQT() - initialUnconfirmedBalance;
    }
    ...
    public long getBalance() {
        return getAccount().getBalanceDQT();
    }
