...
public class TokenTest extends BlockchainTest {
    ...
    public void testParseValidToken() throws Exception {
        ...
        Token actual = Token.parseToken(token, "http://dbn.org");
    ...
    public void testGenerateToken() throws Exception {
        ...
        String tokenString = Token.generateToken("secret", "http://dbn.org");
        int end = Dbn.getEpochTime();
        Token token = Token.parseToken(tokenString, "http://dbn.org");
    ...
    public void emptySecret() throws Exception {
        String tokenString = Token.generateToken("", "http://dbn.org");
        Token token = Token.parseToken(tokenString, "http://dbn.org");
        assertTrue(token.isValid());
    }
