...
public class TestCurrencyIssuance extends BlockchainTest {
    ...
    public void issueMultipleCurrencies() {
        ...
        issueCurrencyApi(apiCall);
        apiCall = new Builder().naming("bXbx", "BXBX", "Currency B").feeDQT(1000 * Constants.ONE_DBN).build();
        issueCurrencyApi(apiCall);
        apiCall = new Builder().naming("ccXcc", "CCCXC", "Currency C").feeDQT(40 * Constants.ONE_DBN).build();
        issueCurrencyApi(apiCall);
    ...
    public static class Builder extends APICall.Builder {
        ...
        public Builder() {
            ...
            feeDQT(0l);
            //feeDQT(25000 * Constants.ONE_DBN);
            param("name", "Test1");
            param("code", "TSXXX");
        ...
        public Builder minReservePerUnitDQT(long minReservePerUnitDQT) {
            param("minReservePerUnitDQT", minReservePerUnitDQT);
            return this;
        }
