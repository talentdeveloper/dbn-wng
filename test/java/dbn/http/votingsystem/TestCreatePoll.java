...
public class TestCreatePoll extends BlockchainTest {
    ...
    public void createValidPoll() {
        ...
        apiCall = new CreatePollBuilder().votingModel(VoteWeighting.VotingModel.DQT.getCode()).build();
        issueCreatePoll(apiCall, false);
        generateBlock();
    }
    ...
    public void createInvalidPoll() {
        APICall apiCall = new CreatePollBuilder().minBalance(-Constants.ONE_DBN).build();
    ...
    public static class CreatePollBuilder extends APICall.Builder {
        ...
        public CreatePollBuilder() {
            ...
            feeDQT(10 * Constants.ONE_DBN);
            param("name", "Test1");
            param("description", "The most cool Beatles guy?");
            param("finishHeight", Dbn.getBlockchain().getHeight() + 100);
            ...
            param("minBalance", 10 * Constants.ONE_DBN);
            param("minBalanceModel", VoteWeighting.MinBalanceModel.DQT.getCode());
