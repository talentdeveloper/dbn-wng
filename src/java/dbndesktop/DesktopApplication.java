...
public class DesktopApplication extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        webEngine.setUserDataDirectory(Dbn.getConfDir());
        ...
        loadWorker.stateProperty().addListener(
                (ov, oldState, newState) -> {
                    ...
                    stage.setTitle("DBN Desktop - " + webEngine.getLocation());
                    if (newState == Worker.State.SUCCEEDED) {
                        ...
                        Dbn.getTransactionProcessor().addListener((transaction) ->
        ...
        stage.getIcons().add(new Image(address + "/img/dbn-icon-32x32.png"));
    ...
    private static String getUrl() {
        ...
        String defaultAccount = Dbn.getStringProperty("dbn.defaultDesktopAccount");
