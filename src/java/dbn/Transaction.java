...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws DbnException.NotValidException;

        Transaction build(String secretPhrase) throws DbnException.NotValidException;
    ...
    void validate() throws DbnException.ValidationException;
