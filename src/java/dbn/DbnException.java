...
public abstract class DbnException extends Exception {

    protected DbnException() {
        super();
    }

    protected DbnException(String message) {
        super(message);
    }

    protected DbnException(String message, Throwable cause) {
        super(message, cause);
    }

    protected DbnException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends DbnException {
    ...
    public static final class DbnIOException extends IOException {

        public DbnIOException(String message) {
            super(message);
        }

        public DbnIOException(String message, Throwable cause) {
            super(message, cause);
        }
