...
public interface Attachment extends Appendix {
    ...
    abstract class AbstractAttachment extends Appendix.AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws DbnException.ValidationException {
        ...
        final int getFinishValidationHeight(Transaction transaction) {
            return isPhased(transaction) ? transaction.getPhasing().getFinishHeight() - 1 : Dbn.getBlockchain().getHeight();
        }
    ...
    final class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAliasSell extends AbstractAttachment {
        ...
        private final String aliasName;
        private final long priceDQT;

        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
            this.priceDQT = buffer.getLong();
        }

        MessagingAliasSell(JSONObject attachmentData) {
            super(attachmentData);
            this.aliasName = Convert.nullToEmpty((String) attachmentData.get("alias"));
            this.priceDQT = Convert.parseLong(attachmentData.get("priceDQT"));
        }

        public MessagingAliasSell(String aliasName, long priceDQT) {
            this.aliasName = aliasName;
            this.priceDQT = priceDQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(priceDQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("alias", aliasName);
            attachment.put("priceDQT", priceDQT);
        }
    ...
    final class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingAliasDelete extends AbstractAttachment {
        ...
        MessagingAliasDelete(final ByteBuffer buffer, final byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    final class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new DbnException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    final class MessagingVoteCasting extends AbstractAttachment {
        ...
        public MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new DbnException.NotValidException("More than " + Constants.MAX_POLL_OPTION_COUNT + " options in a vote");
            }
    ...
    final class MessagingPhasingVoteCasting extends AbstractAttachment {
        ...
        MessagingPhasingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (secretLength > Constants.MAX_PHASING_REVEALED_SECRET_LENGTH) {
                throw new DbnException.NotValidException("Invalid revealed secret length " + secretLength);
            }
            if (secretLength > 0) {
    ...
    final class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        private final long minFeePerByteDQT;
        private final String[] uris;

        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteDQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new DbnException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws DbnException.NotValidException {
            super(attachmentData);
            this.minFeePerByteDQT = (Long) attachmentData.get("minFeePerByte");
            try {
                ...
                throw new DbnException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }

        public MessagingHubAnnouncement(long minFeePerByteDQT, String[] uris) {
            this.minFeePerByteDQT = minFeePerByteDQT;
            this.uris = uris;
        }
        ...
        @Override
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(minFeePerByteDQT);
        ...
        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("minFeePerByteDQT", minFeePerByteDQT);
        ...
        public long getMinFeePerByteDQT() {
            return minFeePerByteDQT;
        }
    ...
    final class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class MessagingAccountProperty extends AbstractAttachment {
        ...
        MessagingAccountProperty(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
    ...
    final class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
    ...
    abstract class ColoredCoinsOrderPlacement extends AbstractAttachment {
        ...
        private ColoredCoinsOrderPlacement(long assetId, long quantityQNT, long priceDQT) {
            this.assetId = assetId;
            this.quantityQNT = quantityQNT;
            this.priceDQT = priceDQT;
        }
    ...
    final class ColoredCoinsAskOrderPlacement extends ColoredCoinsOrderPlacement {
        ...
        public ColoredCoinsAskOrderPlacement(long assetId, long quantityQNT, long priceDQT) {
            super(assetId, quantityQNT, priceDQT);
        }
    ...
    final class ColoredCoinsBidOrderPlacement extends ColoredCoinsOrderPlacement {
        ...
        public ColoredCoinsBidOrderPlacement(long assetId, long quantityQNT, long priceDQT) {
            super(assetId, quantityQNT, priceDQT);
        }
    ...
    final class ColoredCoinsDividendPayment extends AbstractAttachment {
        ...
        ColoredCoinsDividendPayment(JSONObject attachmentData) {
            ...
            this.amountDQTPerQNT = Convert.parseLong(attachmentData.get("amountDQTPerQNT"));
        }

        public ColoredCoinsDividendPayment(long assetId, int height, long amountDQTPerQNT) {
            this.assetId = assetId;
            this.height = height;
            this.amountDQTPerQNT = amountDQTPerQNT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(amountDQTPerQNT);
        }
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("amountDQTPerQNT", amountDQTPerQNT);
        }
        ...
        public long getAmountDQTPerQNT() {
            return amountDQTPerQNT;
        }
    ...
    final class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
        ...
        public DigitalGoodsListing(String name, String description, String tags, int quantity, long priceDQT) {
            this.name = name;
            this.description = description;
            this.tags = tags;
        ...
        public long getPriceDQT() { return priceDQT; }
    ...
    final class DigitalGoodsPriceChange extends AbstractAttachment {
        ...
        public DigitalGoodsPriceChange(long goodsId, long priceDQT) {
            this.goodsId = goodsId;
            this.priceDQT = priceDQT;
        }
    ...
    final class DigitalGoodsPurchase extends AbstractAttachment {
        ...
        public DigitalGoodsPurchase(long goodsId, int quantity, long priceDQT, int deliveryDeadlineTimestamp) {
            this.goodsId = goodsId;
            this.quantity = quantity;
            this.priceDQT = priceDQT;
    ...
    class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        private final long discountDQT;
        private final boolean goodsIsText;

        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            ...
            this.discountDQT = buffer.getLong();
        }
        ...
        DigitalGoodsDelivery(JSONObject attachmentData) {
            ...
            this.discountDQT = Convert.parseLong(attachmentData.get("discountDQT"));
            this.goodsIsText = Boolean.TRUE.equals(attachmentData.get("goodsIsText"));
        }

        public DigitalGoodsDelivery(long purchaseId, EncryptedData goods, boolean goodsIsText, long discountDQT) {
            this.purchaseId = purchaseId;
            this.goods = goods;
            this.discountDQT = discountDQT;
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("discountDQT", discountDQT);
        ...
        public final long getDiscountDQT() {
            return discountDQT;
        }
    ...
    final class UnencryptedDigitalGoodsDelivery extends DigitalGoodsDelivery implements Encryptable {
        ...
        public UnencryptedDigitalGoodsDelivery(long purchaseId, byte[] goodsToEncrypt, boolean goodsIsText, long discountDQT, byte[] recipientPublicKey) {
            super(purchaseId, null, goodsIsText, discountDQT);
        ...
        void putMyBytes(ByteBuffer buffer) {
            if (getGoods() == null) {
                throw new DbnException.NotYetEncryptedException("Goods not yet encrypted");
            }
        ...
        void putMyJSON(JSONObject attachment) {
            if (getGoods() == null) {
                ...
                attachment.put("discountDQT", getDiscountDQT());
                attachment.put("goodsIsText", goodsIsText());
            } else {
    ...
    final class DigitalGoodsRefund extends AbstractAttachment {
        ...
        private final long purchaseId;
        private final long refundDQT;

        DigitalGoodsRefund(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.purchaseId = buffer.getLong();
            this.refundDQT = buffer.getLong();
        }

        DigitalGoodsRefund(JSONObject attachmentData) {
            super(attachmentData);
            this.purchaseId = Convert.parseUnsignedLong((String)attachmentData.get("purchase"));
            this.refundDQT = Convert.parseLong(attachmentData.get("refundDQT"));
        }

        public DigitalGoodsRefund(long purchaseId, long refundDQT) {
            this.purchaseId = purchaseId;
            this.refundDQT = refundDQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(purchaseId);
            buffer.putLong(refundDQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("purchase", Long.toUnsignedString(purchaseId));
            attachment.put("refundDQT", refundDQT);
        }
        ...
        public long getRefundDQT() { return refundDQT; }
    ...
    final class MonetarySystemCurrencyIssuance extends AbstractAttachment {
        ...
        private final long minReservePerUnitDQT;
        ...
        MonetarySystemCurrencyIssuance(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            ...
            this.minReservePerUnitDQT = buffer.getLong();
        ...
        MonetarySystemCurrencyIssuance(JSONObject attachmentData) {
            ...
            this.minReservePerUnitDQT = Convert.parseLong(attachmentData.get("minReservePerUnitDQT"));
        ...
        public MonetarySystemCurrencyIssuance(String name, String code, String description, byte type, long initialSupply, long reserveSupply,
                                              long maxSupply, int issuanceHeight, long minReservePerUnitDQT, int minDifficulty, int maxDifficulty,
            ...
            this.minReservePerUnitDQT = minReservePerUnitDQT;
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(minReservePerUnitDQT);
        ...
        void putMyJSON(JSONObject attachment) {
            ...
            attachment.put("minReservePerUnitDQT", minReservePerUnitDQT);
        ...
        public long getMinReservePerUnitDQT() {
            return minReservePerUnitDQT;
        }
    ...
    final class MonetarySystemReserveIncrease extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private final long amountPerUnitDQT;

        MonetarySystemReserveIncrease(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.currencyId = buffer.getLong();
            this.amountPerUnitDQT = buffer.getLong();
        }

        MonetarySystemReserveIncrease(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.amountPerUnitDQT = Convert.parseLong(attachmentData.get("amountPerUnitDQT"));
        }

        public MonetarySystemReserveIncrease(long currencyId, long amountPerUnitDQT) {
            this.currencyId = currencyId;
            this.amountPerUnitDQT = amountPerUnitDQT;
        }
        ...
        void putMyBytes(ByteBuffer buffer) {
            ...
            buffer.putLong(amountPerUnitDQT);
        }

        @Override
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("amountPerUnitDQT", amountPerUnitDQT);
        }
        ...
        public long getAmountPerUnitDQT() {
            return amountPerUnitDQT;
        }
    ...
    final class MonetarySystemPublishExchangeOffer extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private final long currencyId;
        private final long buyRateDQT;
        private final long sellRateDQT;
        ...
        MonetarySystemPublishExchangeOffer(ByteBuffer buffer, byte transactionVersion) {
            super(buffer, transactionVersion);
            this.currencyId = buffer.getLong();
            this.buyRateDQT = buffer.getLong();
            this.sellRateDQT = buffer.getLong();
        ...
        MonetarySystemPublishExchangeOffer(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.buyRateDQT = Convert.parseLong(attachmentData.get("buyRateDQT"));
            this.sellRateDQT = Convert.parseLong(attachmentData.get("sellRateDQT"));
        ...
        public MonetarySystemPublishExchangeOffer(long currencyId, long buyRateDQT, long sellRateDQT, long totalBuyLimit,
                                                  long totalSellLimit, long initialBuySupply, long initialSellSupply, int expirationHeight) {
            this.currencyId = currencyId;
            this.buyRateDQT = buyRateDQT;
            this.sellRateDQT = sellRateDQT;
        ...
        void putMyBytes(ByteBuffer buffer) {
            buffer.putLong(currencyId);
            buffer.putLong(buyRateDQT);
            buffer.putLong(sellRateDQT);
        ...
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("buyRateDQT", buyRateDQT);
            attachment.put("sellRateDQT", sellRateDQT);
        ...
        public long getBuyRateDQT() {
            return buyRateDQT;
        }

        public long getSellRateDQT() {
            return sellRateDQT;
        }
    ...
    abstract class MonetarySystemExchange extends AbstractAttachment implements MonetarySystemAttachment {
        ...
        private MonetarySystemExchange(JSONObject attachmentData) {
            super(attachmentData);
            this.currencyId = Convert.parseUnsignedLong((String)attachmentData.get("currency"));
            this.rateDQT = Convert.parseLong(attachmentData.get("rateDQT"));
            this.units = Convert.parseLong(attachmentData.get("units"));
        }

        private MonetarySystemExchange(long currencyId, long rateDQT, long units) {
            this.currencyId = currencyId;
        ...
        void putMyJSON(JSONObject attachment) {
            attachment.put("currency", Long.toUnsignedString(currencyId));
            attachment.put("rateDQT", rateDQT);
            attachment.put("units", units);
        }
    ...
    final class MonetarySystemExchangeBuy extends MonetarySystemExchange {
        ...
        public MonetarySystemExchangeBuy(long currencyId, long rateDQT, long units) {
            super(currencyId, rateDQT, units);
        }
    ...
    final class MonetarySystemExchangeSell extends MonetarySystemExchange {
        ...
        public MonetarySystemExchangeSell(long currencyId, long rateDQT, long units) {
            super(currencyId, rateDQT, units);
        }
    ...
    final class ShufflingRecipients extends AbstractShufflingAttachment {
        ...
        ShufflingRecipients(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count < 0) {
                throw new DbnException.NotValidException("Invalid data count " + count);
            }
    ...
    final class ShufflingCancellation extends AbstractShufflingAttachment {
        ...
        ShufflingCancellation(ByteBuffer buffer, byte transactionVersion) throws DbnException.NotValidException {
            super(buffer, transactionVersion);
            int count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new DbnException.NotValidException("Invalid data count " + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (size > Constants.MAX_PAYLOAD_LENGTH) {
                    throw new DbnException.NotValidException("Invalid data size " + size);
                }
            ...
            count = buffer.get();
            if (count > Constants.MAX_NUMBER_OF_SHUFFLING_PARTICIPANTS || count <= 0) {
                throw new DbnException.NotValidException("Invalid keySeeds count " + count);
            }
    ...
    final class TaggedDataUpload extends TaggedDataAttachment {
        ...
        public TaggedDataUpload(String name, String description, String tags, String type, String channel, boolean isText,
                                String filename, byte[] data) throws DbnException.NotValidException {
            ...
            if (isText && !Arrays.equals(data, Convert.toBytes(Convert.toString(data)))) {
                throw new DbnException.NotValidException("Data is not UTF-8 text");
            }
        }
