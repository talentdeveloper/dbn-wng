...
import static dbn.user.JSONResponses.DENY_ACCESS;
import static dbn.user.JSONResponses.INCORRECT_REQUEST;
import static dbn.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws DbnException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Dbn.getBooleanProperty("dbn.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|DbnException e) {
