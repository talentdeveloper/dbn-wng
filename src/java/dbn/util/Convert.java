...
public final class Convert {
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws DbnException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new DbnException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseDBN(String dbn) {
        return parseStringFraction(dbn, 8, Constants.MAX_BALANCE_DBN);
    }
