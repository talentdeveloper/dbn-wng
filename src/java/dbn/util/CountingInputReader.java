...
import dbn.DbnException.DbnIOException;
...
public class CountingInputReader extends FilterReader {
     ...
     * @throws  DbnIOException      Maximum count exceeded
     */
    private void incCount(long c) throws DbnIOException {
        count += c;
        if (count > limit)
            throw new DbnIOException("Maximum size exceeded: " + count);
    }
}
