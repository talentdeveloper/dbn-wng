...
/**
 * Java LogManager extension for use with Dbn
 */
public class DbnLogManager extends LogManager {

    /** Logging reconfiguration in progress */
    private volatile boolean loggingReconfiguration = false;

    /**
     * Create the Dbn log manager
     *
     ...
     * done terminating the Dbn processes.
     */
    public DbnLogManager() {
        super();
    }
     ...
     * This allows us to continue to use logging facilities during Dbn shutdown.
     */
    @Override
    public void reset() {
    ...
    /**
     * Dbn shutdown is now complete, so call LogManager.reset() to terminate
     * the log handlers.
     */
    void dbnShutdown() {
        super.reset();
