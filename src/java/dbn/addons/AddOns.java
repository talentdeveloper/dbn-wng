...
import dbn.Dbn;
import dbn.http.APIServlet;
import dbn.http.APITag;
...
public final class AddOns {
    ...
    static {
        ...
        Dbn.getStringListProperty("dbn.addOns").forEach(addOn -> {
            try {
        ...
        if (!addOns.isEmpty() && !Dbn.getBooleanProperty("dbn.disableSecurityPolicy")) {
            System.setProperty("java.security.policy", Dbn.isDesktopApplicationEnabled() ? "dbndesktop.policy" : "dbn.policy");
