...
public abstract class Order {
    ...
    private static void matchOrders(long assetId) {
        ...
        while ((askOrder = Ask.getNextOrder(assetId)) != null
            ...
            if (askOrder.getPriceDQT() > bidOrder.getPriceDQT()) {
                break;
            }
            ...
            askAccount.addToBalanceAndUnconfirmedBalanceDQT(LedgerEvent.ASSET_TRADE, askOrder.getId(),
                            Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceDQT()));
            ...
            bidAccount.addToBalanceDQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                            -Math.multiplyExact(trade.getQuantityQNT(), trade.getPriceDQT()));
            bidAccount.addToUnconfirmedBalanceDQT(LedgerEvent.ASSET_TRADE, bidOrder.getId(),
                            Math.multiplyExact(trade.getQuantityQNT(), (bidOrder.getPriceDQT() - trade.getPriceDQT())));
        }
    ...
    public String toString() {
        return getClass().getSimpleName() + " id: " + Long.toUnsignedString(id) + " account: " + Long.toUnsignedString(accountId)
                + " asset: " + Long.toUnsignedString(assetId) + " price: " + priceDQT + " quantity: " + quantityQNT
    ...
    */
    ...
    public static final class Ask extends Order {
        ...
        public int compareTo(Ask o) {
            if (this.getPriceDQT() < o.getPriceDQT()) {
                return -1;
            } else if (this.getPriceDQT() > o.getPriceDQT()) {
                return 1;
            } else {
