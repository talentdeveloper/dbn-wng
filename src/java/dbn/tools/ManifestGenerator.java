...
import dbn.Dbn;
import dbn.env.service.DbnService_ServiceManagement;
...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/dbn.manifest.mf", Dbn.class.getCanonicalName(), "./lib");
        String serviceClassName = DbnService_ServiceManagement.class.getCanonicalName();
        serviceClassName = serviceClassName.substring(0, serviceClassName.length() - "_ServiceManagement".length());
        manifestGenerator.generate("./resource/dbnservice.manifest.mf", serviceClassName, "./lib");
    }
