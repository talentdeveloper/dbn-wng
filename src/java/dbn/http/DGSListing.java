...
import static dbn.http.JSONResponses.INCORRECT_DGS_LISTING_DESCRIPTION;
import static dbn.http.JSONResponses.INCORRECT_DGS_LISTING_NAME;
import static dbn.http.JSONResponses.INCORRECT_DGS_LISTING_TAGS;
...
public final class DGSListing extends CreateTransaction {
    ...
    private DGSListing() {
        super("messageFile", new APITag[] {APITag.DGS, APITag.CREATE_TRANSACTION},
                "name", "description", "tags", "quantity", "priceDQT");
    }
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DbnException {
        ...
        Attachment attachment = new Attachment.DigitalGoodsListing(name, description, tags, quantity, priceDQT);
