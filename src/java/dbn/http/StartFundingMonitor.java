...
import static dbn.http.JSONResponses.MONITOR_ALREADY_STARTED;
import static dbn.http.JSONResponses.UNKNOWN_ACCOUNT;
import static dbn.http.JSONResponses.incorrect;

/**
 * Start a funding monitor
 * <p>
 * A funding monitor will transfer DBN, ASSET or CURRENCY from the funding account
 ...
 * <p>
 * DBN amounts are specified with 8 decimal places.  Asset and Currency decimal places
...
public final class StartFundingMonitor extends APIServlet.APIRequestHandler {
     ...
     * @throws  DbnException        Unable to process request
     */
    @Override
