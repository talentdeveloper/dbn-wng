...
public final class ShufflingCreate extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DbnException {
        ...
        if (holdingType == HoldingType.DBN && amount < Constants.SHUFFLING_DEPOSIT_DQT) {
            return JSONResponses.incorrect("amount", "Minimum shuffling amount is " + Constants.SHUFFLING_DEPOSIT_DQT / Constants.ONE_DBN + " DBN");
        }
