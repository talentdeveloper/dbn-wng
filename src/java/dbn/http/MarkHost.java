...
import static dbn.http.JSONResponses.INCORRECT_DATE;
import static dbn.http.JSONResponses.INCORRECT_HOST;
import static dbn.http.JSONResponses.INCORRECT_WEIGHT;
import static dbn.http.JSONResponses.MISSING_DATE;
import static dbn.http.JSONResponses.MISSING_HOST;
import static dbn.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws ParameterException {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_DBN) {
