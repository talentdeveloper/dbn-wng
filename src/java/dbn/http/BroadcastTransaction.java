 ...
 * Clients first submit their transaction using {@link dbn.http.CreateTransaction} without providing the secret phrase.<br>
 * In response the client receives the unsigned transaction JSON and transaction bytes.
 * <p>
 * The client then signs and submits the signed transaction using {@link dbn.http.BroadcastTransaction}
 * <p>
 * The default wallet implements this procedure in nrs.server.js which you can use as reference.
 * <p>
 * {@link dbn.http.BroadcastTransaction} accepts the following parameters:<br>
 ...
 * <p>
 * Prunable appendages are classes implementing the {@link dbn.Appendix.Prunable} interface.
 */
