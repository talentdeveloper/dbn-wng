 ...
 * account ledger tracks all account changes as determined by the dbn.ledgerAccounts,
 * dbn.ledgerLogUnconfirmed and dbn.ledgerTrimKeep properties.
 * </p>
 * <table>
 ...
 *           The administrator password is required if more than dbn.maxAPIRecords entries are to be searched.
 *       </td>
 *     </tr>
 *     <tr>
 *       <td>event</td>
 ...
 *           The maximum number of entries returned is limited by the dbn.maxAPIRecords property
 ...
 *     <tr>
 *       <td>DBN_BALANCE</td>
 *       <td>Change in the DBN balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *     <tr>
 ...
 *     </tr>
 *     <tr>
 *       <td>UNCONFIRMED_DBN_BALANCE</td>
 *       <td>Change in the unconfirmed DBN balance for the account.  There is no 'holding'.</td>
 *     </tr>
 *   </tbody>
 * </table>
 */
public class GetAccountLedger extends APIServlet.APIRequestHandler {
     ...
     * @return                      API response
     * @throws  DbnException        Invalid request
     */
    @Override
