...
import static dbn.http.JSONResponses.INCORRECT_ALIAS_OWNER;
import static dbn.http.JSONResponses.INCORRECT_RECIPIENT;
...
public final class SellAlias extends CreateTransaction {
    ...
    private SellAlias() {
        super(new APITag[] {APITag.ALIASES, APITag.CREATE_TRANSACTION}, "alias", "aliasName", "recipient", "priceDQT");
    }
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws DbnException {
        ...
        long priceDQT = ParameterParser.getLong(req, "priceDQT", 0L, Constants.MAX_BALANCE_DQT, true);
        ...
        Attachment attachment = new Attachment.MessagingAliasSell(alias.getAliasName(), priceDQT);
