...
/*
    DBN address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: DbnChg (admin@dbnchg.com).
*/
...
function DbnAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('DBN-') == 0) adr = adr.substr(4);
