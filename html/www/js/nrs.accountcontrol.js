...
var NRS = (function(NRS, $) {
	...
	$("#set_mandatory_approval_modal").on("show.bs.modal", function(e) {
		...
		var context = {
			labelText: "Amount DBN",
			labelI18n: "amount_dbn",
			helpI18n: "approve_transaction_amount_help",
			inputName: "controlQuorumDBN",
			addonText: "DBN",
			addonI18n: "dbn_unit"
		}
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_amount_dbn', 'simple_input_with_addon_modal_ui_element', context);
		...
		context['inputName'] = 'controlMinBalanceDBN';
		context['addonText'] = 'DBN';
		context['addonI18n'] = 'dbn_unit';
		var $elems = NRS.initModalUIElement($modal, '.phasing_only_min_balance_dbn', 'simple_input_with_addon_modal_ui_element', context);
		$elems.find('input').prop("disabled", true);
		$elems.hide();
