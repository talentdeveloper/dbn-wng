...
var NRS = (function(NRS, $) {
	var index = 0;
	var bundles = [
		{alias: "nrsVersion", status: "release", prefix: "dbn-client-", ext: "zip"},
		{alias: "nrsBetaVersion", status: "beta", prefix: "dbn-client-", ext: "zip"},
		{alias: "nrsVersionWin", status: "release", prefix: "dbn-client-", ext: "exe"},
		{alias: "nrsBetaVersionWin", status: "beta", prefix: "dbn-client-", ext: "exe"},
		{alias: "nrsVersionMac", status: "release", prefix: "dbn-installer-", ext: "dmg"},
		{alias: "nrsBetaVersionMac", status: "beta", prefix: "dbn-installer-", ext: "dmg"},
		{alias: "nrsVersionLinux", status: "release", prefix: "dbn-client-", ext: "sh"},
		{alias: "nrsBetaVersionLinux", status: "beta", prefix: "dbn-client-", ext: "sh"}
	];
	...
	NRS.downloadClientUpdate = function(status, ext) {
        ...
        var fileurl = "https://bitbucket.org/JeanLucPicard/dbn/downloads/" + filename;
