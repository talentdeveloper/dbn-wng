...
var NRS = (function(NRS, $) {
    ...
    $("#add_monitored_account_modal").on("show.bs.modal", function() {
        ...
        $("#add_monitored_account_amount").val(NRS.convertToDBN(currentMonitor.amount));
        $("#add_monitored_account_threshold").val(NRS.convertToDBN(currentMonitor.threshold));
    ...
    $(".add_monitored_account_value").on('change', function() {
        ...
        var value = {};
        var amount = NRS.convertToDQT($("#add_monitored_account_amount").val());
        if (currentMonitor.amount != amount) {
            value.amount = amount;
        }
        var threshold = NRS.convertToDQT($("#add_monitored_account_threshold").val());
