...
QUnit.test("convertToDBN", function (assert) {
    assert.equal(NRS.convertToDBN(200000000), "2", "whole");
    assert.equal(NRS.convertToDBN(20000000), "0.2", "fraction");
    assert.equal(NRS.convertToDBN(-200000000), "-2", "negative");
    assert.equal(NRS.convertToDBN(-20000000), "-0.2", "fraction.negative");
    assert.equal(NRS.convertToDBN(-220000000), "-2.2", "whole.fraction.negative");
    assert.equal(NRS.convertToDBN(2), "0.00000002", "nqt");
    assert.equal(NRS.convertToDBN(-2), "-0.00000002", "nqt.negative");
    assert.equal(NRS.convertToDBN(new BigInteger(String(2))), "0.00000002", "input.object");
    assert.equal(NRS.convertToDBN("hi"), "0.00000188", "alphanumeric"); // strange behavior of BigInteger don't do that
    assert.throws(function () {
        NRS.convertToDBN(null);
    }, {
...
QUnit.test("formatAmount", function (assert) {
    ...
    assert.equal(NRS.formatAmount("123456700000000", true, true), Number("1234567").toLocaleString(), "dbn.rounding");
...
QUnit.test("calculateOrderTotalDQT", function (assert) {
    assert.equal(NRS.calculateOrderTotalDQT(12, 34), "408", "multiplication");
});
...
QUnit.test("convertToDQT", function (assert) {
    assert.equal(NRS.convertToDQT(1), "100000000", "one");
    assert.equal(NRS.convertToDQT(1.), "100000000", "one.dot");
    assert.equal(NRS.convertToDQT(1.0), "100000000", "one.dot.zero");
    assert.equal(NRS.convertToDQT(.1), "10000000", "dot.one");
    assert.equal(NRS.convertToDQT(0.1), "10000000", "zero.dot.one");
    assert.equal(NRS.convertToDQT("0.00000001"), "1", "nqt");
    assert.throws(function () {
        NRS.convertToDQT(0.00000001); // since it's passed as 1e-8
    }, "Invalid input.", "invalid.input");
});
...
QUnit.test("getAccountLink", function (assert) {
    ...
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831 }, "entity"), "<a href='#' data-user='DBN-XKA2-7VJU-VZSY-7R335' class='show_account_modal_action user-info'>/</a>", "numeric");
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>DBN-XK4R-7VJU-6EQG-7R335</a>", "RS");
    assert.equal(NRS.getAccountLink({ entity: 5873880488492319831, entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>DBN-XK4R-7VJU-6EQG-7R335</a>", "numeric.and.RS");
    NRS.contacts = { "DBN-XK4R-7VJU-6EQG-7R335": { name: "foo" }};
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>foo</a>", "contact");
    NRS.accountRS = "DBN-XK4R-7VJU-6EQG-7R335";
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>You</a>", "you");
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity", "DBN-XK4R-7VJU-6EQG-7R335", "My Precious"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>My Precious</a>", "force.account.name");
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, true), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info'>DBN-XK4R-7VJU-6EQG-7R335</a>", "maintain.rs.format");
    assert.equal(NRS.getAccountLink({ entityRS: "DBN-XK4R-7VJU-6EQG-7R335" }, "entity", undefined, undefined, undefined, "btn btn-xs"), "<a href='#' data-user='DBN-XK4R-7VJU-6EQG-7R335' class='show_account_modal_action user-info btn btn-xs'>You</a>", "add.class");
    NRS.contacts = null;
    NRS.accountRS = null;
    NRS.constants.GENESIS = 1739068987193023818;
    NRS.constants.GENESIS_RS = "DBN-MR8N-2YLS-3MEQ-3CMAJ";
    assert.equal(NRS.getAccountLink({ entityRS: NRS.constants.GENESIS_RS }, "entity"), "<a href='#' data-user='DBN-MR8N-2YLS-3MEQ-3CMAJ' class='show_account_modal_action user-info'>Genesis</a>", "genesis");
});
