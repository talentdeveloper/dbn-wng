...
then
echo obfuscate
/opt/proguard/bin/proguard.sh @dbn.pro
...
cd -
zip -q -X -r ${PACKAGE}.zip dbn -x \*/.idea/\* \*/.gitignore \*/.git/\* \*/\*.log \*.iml dbn/conf/dbn.properties dbn/conf/logging.properties dbn/conf/localstorage/\*
rm -rf dbn
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/dbn/downloads/${PACKAGE}.zip" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/dbn/downloads/${PACKAGE}.sh" >> ${CHANGELOG}
echo >> ${CHANGELOG}
echo "sha256:" >> ${CHANGELOG}
echo >> ${CHANGELOG}
...
echo >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/dbn/downloads/${PACKAGE}.exe" >> ${CHANGELOG}
echo >> ${CHANGELOG}
#echo "sha256:" >> ${CHANGELOG}
#sha256sum ${PACKAGE}.exe >> ${CHANGELOG}
echo "https://bitbucket.org/JeanLucPicard/dbn/downloads/dbn-installer-${VERSION}.dmg" >> ${CHANGELOG}
echo >> ${CHANGELOG}

echo "The exe, dmg, and sh packages must have a digital signature by \"Stichting DBN\"." >> ${CHANGELOG}
