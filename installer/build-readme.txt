Building the DBN installer

Note: all pathes are relative to the git repository folder (dbn-private)
...
Test X11 installer: java -jar dbn-client-<version>.jar
Test console installer: java -jar dbn-client-<version>.jar -console
...
Copy the content of Java JRE folder (C:\Program Files\Java\jre<version>) into the jre folder under your dbn-private git repository preserving the folder structure
...
Test the installer using Java: java -jar dbn-client-<version>.jar
Test the windows executable: dbn-client-<version>.exe
...
dbn.jar is now self executing, the full classpath is embedded into the jar file manifest automatically by jar.sh
